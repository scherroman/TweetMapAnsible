...
This section explains how to use the given ansible scripts to setup and interact with an array of generic private servers and build our distributed server infrastructure for TweetMap.
### Update Hosts File
